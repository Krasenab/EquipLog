        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CorporateID = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AddedFrom = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ...
                    EqиipmentId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EquipmentParts_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EquipmentId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    EquipmentPartsId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppImages_EquipmentParts_EquipmentPartsId",
                        column: x => x.EquipmentPartsId,
                        principalTable: "EquipmentParts",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppImages_Equipments_EquipmentId",
                        column: x => x.EquipmentId,
                        principalTable: "Equipments",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppImages_EquipmentId",
                table: "AppImages",
                column: "EquipmentId");

            migrationBuilder.CreateIndex(
                name: "IX_AppImages_EquipmentPartsId",
                table: "AppImages",
                column: "EquipmentPartsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EquipmentParts_CategoryId",
